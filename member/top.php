...
$query = query_execute_sqli("SELECT image FROM users WHERE id_user = '$login_id'");
$image = mysqli_fetch_array($query)[0];

$profil_photo ='<img src="assets/images/users/user.png" alt="avatar" />';
if($image != ''){
	$profil_photo = "<img src='images/mlm_profile_image/$image' alt='avatar' />";
}
?>
			...
			<ul class="nav navbar-nav flex-row">
				...
				<li class="nav-item">
					<a class="navbar-brand" href="index.php">
						<img class="brand-logo img-responsive" alt="UNICGROW" src="assets/images/logo1.png" style="width:40px; height: 45px;"/>
						<h3 class="brand-text">TRON</h3>
					</a>
				</li>
				...
				<ul class="nav navbar-nav float-right">
					<li class="dropdown dropdown-user nav-item">
						...
						<a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
							<span class="mr-1">
								...
								<span class="user-name text-bold-700">
									<?=$_SESSION['mlmproject_user_full_name']?>
								</span>
							</span>
							<span class="avatar avatar-online">
								<?=$profil_photo?><!--<img src="assets/images/users/user.png" alt="avatar">--> <i></i>
							</span>
						</a>
						<div class="dropdown-menu dropdown-menu-right">
							...
							<a class="dropdown-item" href="index.php?page=edit-password">
							...
							<li class="scrollable-container media-list w-100">
									...
									<div class="media">
										<div class="media-left">
											<span class="avatar avatar-sm avatar-online rounded-circle">
												<img src="assets/images/users/avatar-s-19.png" alt="avatar"><i></i>
											</span>
										</div>
										<div class="media-body">
									...
									<div class="media">
										<div class="media-left">
											<span class="avatar avatar-sm avatar-busy rounded-circle">
												<img src="assets/images/users/avatar-s-2.png" alt="avatar"><i></i>
											</span>
										</div>
										<div class="media-body">
								...
								<a href="javascript:void(0)">
									<div class="media">
										<div class="media-left">
											<span class="avatar avatar-sm avatar-online rounded-circle">
												<img src="assets/images/users/avatar-s-3.png" alt="avatar"><i></i>
											</span>
										</div>
										<div class="media-body">
									...
									<div class="media">
										<div class="media-left">
											<span class="avatar avatar-sm avatar-away rounded-circle">
												<img src="assets/images/users/avatar-s-6.png" alt="avatar"><i></i>
											</span>
										</div>
										<div class="media-body">
