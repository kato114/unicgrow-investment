...
{
	if($_REQUEST['login_code'] == $_SESSION['code'])
	{
		$username = $_REQUEST['username'];
		$password = $_REQUEST['password'];
		?>
		<script type="text/javascript">
			window.location = "login_check.php?username=<?=$username?>&password=<?=$password?>";
		</script> <?php
	}
	else{ $error_code = "<B class='text-danger'>Please enter correct code!</B>"; }
}
...
<title>UNICGROW - Login Panel</title>
					...
					<div class="col-md-4 col-10 box-shadow-2 p-0">
						<div class="card border-grey border-lighten-3 m-0">
							<div class="card-header border-0 pb-0">
								...
								<?PHP 
								if($_POST['err']== 1)
								{ echo "<B class='text-danger'>UserName or Password is Incorrect !!</B>"; }
								echo $error_code;
								?>
							</div>
							...
							<div class="card-content">
								<div class="card-body">
									<form class="form-horizontal" action="login.php" novalidate method="post">
										<fieldset class="form-group position-relative has-icon-left">
											<input type="text" class="form-control" placeholder="Enter Your Username" tabindex="1" name="username" />
											<div class="form-control-position"><i class="ft-user"></i></div>
											<div class="help-block font-small-3"></div>
										</fieldset>
										<fieldset class="form-group position-relative has-icon-left">
											<input type="password" class="form-control" placeholder="Enter Your Password" tabindex="2" name="password" />
										...
										<div class="form-group row">
											<div class="col-md-9 col-12 text-center text-md-left">
												<fieldset class="form-group position-relative has-icon-left">
													<input type="password" class="form-control" placeholder="Enter Security code" tabindex="2" name="login_code" />
													<div class="form-control-position">
												<i class="ft-lock"></i>
											</div>
												</fieldset>
										...
										<div class="form-group row">
											...
											<div class="col-md-6 col-12 text-center text-md-right">
												<a href="forget_password.php" class="card-link">
													Forgot Password?
												</a>
											</div>
										</div>
										<button type="submit" class="btn btn-success btn-block btn-lg" name="login">
											<i class="ft-unlock"></i> Login Now
										</button>
									</form>
								</div>
							</div>
							<div class="card-footer border-0">
								<p class="card-subtitle line-on-side text-muted text-center font-small-3 mx-2 my-1">
									<span>New to UNICGROW ?</span>
								</p>
								<a href="register.php" class="btn btn-danger btn-block btn-lg mt-3">
