...
<div class="col-lg-12 text-right">
	...
	<a href="index.php?page=ledger_smgwal" class="btn btn-success btn-xs disabled">SMG Wallet</a>
...
WHERE t1.wall_type = 'Trade Gaming Wallet' AND t1.user_id = '$login_id'
...
{ ?>
	<table class="table table-bordered">
		...
		{ 	
			...
			$st_date = $row['date'];
			$wall_balance = round($row['wallet_balance'],4);
			$en_date = date('Y-m-d');
			$wr = $cr > 0 ? $cr : $dr;
			$sign = $cr > 0 ? "+" : "-";
			?>
