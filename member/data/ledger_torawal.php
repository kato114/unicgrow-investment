...
<div class="col-lg-12 text-right">
	<!--<a href="index.php?page=ledger_cashwal" class="btn btn-success btn-xs disabled">Cash Wallet</a>
	<a href="index.php?page=ledger_main" class="btn btn-success btn-xs">Wallet & Statement </a>-->
	...
	<a href="index.php?page=ledger_torawal" class="btn btn-success btn-xs disabled">ToraGlobal Wallet</a>
</div>
...
WHERE t1.wall_type = 'Share Holder Wallet' AND t1.user_id = '$login_id'
