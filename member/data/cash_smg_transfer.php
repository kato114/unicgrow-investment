...
$cash_amount = get_user_allwallet($login_id,'trade_gaming');
		...
		elseif($_POST['submit'] == 'Submit' and $_SESSION['ses'] == 1)
		{
			...
			if($_SESSION['request_amount'] == $req_amount)
			{
				if($_SESSION['requested_user_id'] == $req_user_id){
					...
					insert_wallet_account($req_user_id, $login_id, $req_amount, $systems_date_time, $acount_type[37],$acount_type_desc[37], 1, $wal_bal,$wallet_type[4],$remarks = "Credit SMG By CASH Wallet");
					
					$wal_bal = get_user_allwallet($req_user_id,'amount');
					insert_wallet_account($login_id, $req_user_id, $req_amount, $systems_date_time, $acount_type[38],$acount_type_desc[38], 2, $wal_bal,$wallet_type[1],$remarks = "Transfer CASH To SMG Wallet");
