...
$sql = "SELECT * FROM income WHERE user_id = '$user_id' AND type = '$income_type[1]' $qur_set_search ORDER BY date DESC";
...
<div class="col-md-12">&nbsp;</div>
	<table class="table table-bordered table-hover table-responsive">
		<thead>
		<tr><th colspan="4">Total Income : &#36;  <?=round($amount,2)?></th></tr>
		<tr>
