	...
	if($_POST['submit'] == 'Submit')
	{
		...
		if($amount != 0)
		{
			...
			?>
				...
				<form name="alert_pay" action="https://www.alertpay.com
/PayProcess.aspx" method="post" >
				...
				<input type="hidden" name="req_amount" value="<?php print $amount; ?>"  />
				  ...
				  <tr>
					...
					<td><input type="text" name="currency"  class="input-medium" /></td>
				  </tr>
				  <tr>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				  ...
				  <tr>
					<td colspan="2" align="center"><input type="submit" name="submit" value="Alert Pay"  /></td>
				  </tr>
				</table>
		...
		<?php	}
			...
			?>
				<table width="600" border="0">
				<form name="liberty_pay" action="http://www.libertyreserve.com/en/help/apiguide" method="post" >
				<input type="hidden" name="customer_id" value="<?php print $user_id; ?>"  />
				<input type="hidden" name="req_amount" value="<?php print $amount; ?>"  />
				  <tr>
