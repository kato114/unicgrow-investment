	...
	if(isset($_POST['submit']))
	{
		...
		elseif($_POST['submit'] == 'Submit' and $_SESSION['ses'] == 1)
		{
			...
			if($_SESSION['request_amount'] == $req_amount)
			{
				...
				$wal_bal = get_user_allwallet($login_id,'amount');
				insert_wallet_account($login_id, $req_user_id, $req_amount, $systems_date_time, $acount_type[19],$acount_type_desc[19], 2, $wal_bal,$wallet_type[1],$remarks = "Transfer Cash To GTS Wallet");
				
				$wal_bal = get_user_allwallet($req_user_id,'trade_gaming');
				insert_wallet_account($req_user_id, $login_id, $req_amount, $systems_date_time, $acount_type[18],$acount_type_desc[18], 1, $wal_bal,$wallet_type[4],$remarks = "Credit GTS By Cash Wallet");
