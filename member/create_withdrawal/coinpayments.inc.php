...
class CoinPaymentsAPI {
    ...
    public function GetTxInfo($req) {
		// See https://www.coinpayments.net/apidoc-get-tx-info for parameters
		return $this->api_call('get_tx_info', $req);
	}
	public function GetTxList($req) {
		// See https://www.coinpayments.net/apidoc-get-tx-info for parameters
    ...
    public function GetDepositAddress($currency, $ipn_url = '') {		
		$req = array(
			'currency' => $currency,
			'ipn_url' => $ipn_url,
			'lable' => 'register',
	...
	public function CreateMassWithdrawal($req) {		
		/*$req = array(
			'amount' => $amount,
			'currency' => $currency,
			'address' => $address,
