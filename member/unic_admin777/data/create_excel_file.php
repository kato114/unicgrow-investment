...
//include("../../config.php");
	$result = query_execute_sqli("select username , email , alert_email , liberty_email from users ");
	...
	?>
		<a style="color:#333368; font-weight:600;" href="index.php?page=all_users">Back</a>
	<?php		
