...
<form method="post" action="index.php?page=diamond_qualifier">
...
$sql = "SELECT * FROM users WHERE matching_qualification > 0 $qur_set_search ORDER BY id_user DESC";	
$SQL = "$sql LIMIT $tstart,$tot_p ";

$query = query_execute_sqli($SQL);
$totalrows = mysqli_num_rows($query);

$sqlk = "SELECT COUNT(id_user) num FROM users WHERE matching_qualification > 0 $qur_set_search";
