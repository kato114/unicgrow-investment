...
{ ?>
	<p style='text-align:left;'><a href='index.php?page=news_list&p=<?=$newp?>' class='btn btn-info'>Back</a></p>
		...
		<table class="table table-bordered">
			...
			{ 
				...
				<tr class="text-center">
					<td><?=$sr_no?></td>
					<td><?=$date?></td>	
					<td><a href="index.php?page=news_list&p=<?=$newp?>&news_no=<?=$id?>"><?=$title?></a></td>
					<td>
