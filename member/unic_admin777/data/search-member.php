...
<form name="my_form" action="index.php?page=search-member" method="post">
  <tr>
    <td align="center" colspan="2" class="td_title" style="font-size:16px; color:#999999;"><strong>Member Information</strong><p></p></td>
  </tr>
  <tr>
    <td class="td_title"><p>Enter Member UserName</p></td>
   <p> <td><input type="text" name="user_name" size=3 class="form-control"/></p></td>
  </tr>
  <tr>
    <td align="center" colspan="2"><p align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" name="submit" value="Submit" class="btn btn-info" /></p></td>
