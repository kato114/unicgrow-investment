...
<div class="col-md-2">
	<form action="index.php?page=excel_bonus" method="post">
		...
		<input type="hidden" name="inc_type" value="6" />
...
<?php
$sql = "SELECT t1.*,t2.username 'from',t3.username FROM income t1
left join users t2 on t1.incomed_id = t2.id_user
left join users t3 on t1.user_id = t3.id_user
WHERE t1.type = 9 $qur_set_search ORDER BY t1.date DESC";
...
if($totalrows > 0){ ?>
	...
	<table class="table table-bordered">
		...
		<tr>
			...
			<th class="text-center">Level Bonus</th>
