...
<div class="col-lg-12 text-right">
	<a href="index.php?page=crdr_mainwal_reports" class="btn btn-success btn-xs ">Deposit Wallet Statement</a>
	<a href="index.php?page=crdr_smg_statement" class="btn btn-success btn-xs">SMG Wallet Statement</a>
	<a href="index.php?page=crdr_tora_statement" class="btn btn-success btn-xs disabled">Tora Share Statement</a>
</div>
...
WHERE (t1.wall_type = 'Share Holder Wallet') $qur_set_search ORDER BY t1.date DESC";	//t1.type IN(13,19) AND
