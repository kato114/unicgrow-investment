...
if(isset($_POST['submit']) and ($_SESSION['dccan_admin_login'] == 1))
{
	if($_POST['submit'] == 'Accept')
	{
		...
		query_execute_sqli("insert into reg_fees_structure (user_id , update_fees , date , end_date , profit , total_days , invest_type) values ('$user_id' , '$request_amount' , '$date' , '$end_date' , '$profit' , '$days' , '$plan_type') ");
