	...
	<tr>
		<td>
			<form action="index.php?page=excel_bonus" method="post">
				<input type="hidden" name="bonus_name" value="Salary Income" />
				<input type="hidden" name="inc_type" value="1" />
...
WHERE t1.type = 1 $qur_set_search ORDER BY t1.date DESC";	
...
{ ?>
	<table class="table table-bordered">
		<thead><tr><th colspan="6">Total Salary Bonus : <?=$amount; ?> &#36;</th></tr>
		<tr>
