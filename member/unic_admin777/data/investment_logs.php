...
$query = query_execute_sqli("select * from logs where type = '$log_type[5]' ");
...
if($totalrows != 0)
{
	...
	$query = query_execute_sqli("select * from logs where type = '$log_type[5]' LIMIT $start,$plimit ");			
...
else { print "<table align=\"center\" hspace = 0 cellspacing=0 cellpadding=0 border=0 width=600><tr><td colspan=\"3\" width=200 class=\"td_title\">There is no logs !</td></tr></table>"; }
