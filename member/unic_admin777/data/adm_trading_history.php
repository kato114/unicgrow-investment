...
if(isset($_POST['Search'])){
	...
	if($_POST['type_by'] != ''){
		...
		switch($type_by){
			case 1 : $qur_set_search .= " AND t1.type = 1"; $select1 = 'selected="selected"'; break;
			case 2 : $qur_set_search .= " AND t1.type = 2"; $select2 = 'selected="selected"'; break;
		}
	}
}
?>
...
WHERE t1.panel_id > 0 $qur_set_search ORDER BY t1.date DESC";	
