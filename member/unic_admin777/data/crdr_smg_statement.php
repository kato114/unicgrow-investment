...
<div class="col-lg-12 text-right">
	...
	<a href="index.php?page=crdr_smg_statement" class="btn btn-success btn-xs disabled">SMG Wallet Statement</a>
...
WHERE (t1.wall_type = 'Trade Gaming Wallet') $qur_set_search ORDER BY t1.date DESC";	//t1.type IN(13,19) AND
