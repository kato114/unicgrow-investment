...
//include("../../config.php");
	$result = query_execute_sqli("select f_name , l_name , phone_no from users ");
	$num = mysqli_num_rows($result);
	if($num > 0)
	{
		$file_name = time()."users_phone_info".date('Y-m-d');
	...
	?>
		<a style="color:#333368; font-weight:600;" href="index.php?page=all_users_phone">Back</a>
	<?php		
